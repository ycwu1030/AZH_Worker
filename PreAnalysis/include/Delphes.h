...
// Thu Sep  2 18:49:38 2021 by ROOT version 6.22/06
// from TTree Delphes/Analysis tree
// found on file:
// delphes_gg_ztt_Type-I_total_202108290019_0x010_20_3l_20210829_132405.root
//////////////////////////////////////////////////////////
...
public:
    ...
    static constexpr Int_t kMaxJet = 25;
    static constexpr Int_t kMaxElectron = 5;
    static constexpr Int_t kMaxPhoton = 5;
...
Delphes::Delphes(TTree *tree) : fChain(0) {
    ...
    if (tree == 0) {
        TFile *f = (TFile *)gROOT->GetListOfFiles()->FindObject(
            "delphes_gg_ztt_Type-I_total_202108290019_0x010_20_3l_20210829_132405."
            "root");
        if (!f || !f->IsOpen()) {
            f = new TFile(
                "delphes_gg_ztt_Type-I_total_202108290019_0x010_20_3l_20210829_"
                "132405.root");
        }
