...
V_113 = Vertex(name='V_113',
               ...
               couplings={(1, 0): C.GC_9, (0, 0): C.GC_9, (2, 1): C.GC_9, (0, 1): C.GC_8, (2, 2): C.GC_8, (1, 2): C.GC_8})
...
V_132 = Vertex(name='V_132',
               particles=[P.b__tilde__, P.tp, P.G__minus__],
               color=['Identity(1,2)'],
               lorentz=[L.FFS3],
               couplings={(0, 0): C.GC_12})

V_133 = Vertex(name='V_133',
               particles=[P.b__tilde__, P.tp, P.H__minus__],
               color=['Identity(1,2)'],
               lorentz=[L.FFS3],
               couplings={(0, 0): C.GC_16})

V_134 = Vertex(name='V_134',
               particles=[P.tp__tilde__, P.tp, P.G0],
               color=['Identity(1,2)'],
               lorentz=[L.FFS3, L.FFS4],
               couplings={(0, 0): C.GC_146, (0, 1): C.GC_145})

V_135 = Vertex(name='V_135',
               particles=[P.tp__tilde__, P.tp, P.HH],
               color=['Identity(1,2)'],
               lorentz=[L.FFS3, L.FFS4],
               couplings={(0, 0): C.GC_150_tp, (0, 1): C.GC_150_tp})

V_136 = Vertex(name='V_136',
               particles=[P.tp__tilde__, P.tp, P.HA],
               color=['Identity(1,2)'],
               lorentz=[L.FFS3, L.FFS4],
               couplings={(0, 0): C.GC_148_tp, (0, 1): C.GC_147_tp})

V_137 = Vertex(name='V_137',
               particles=[P.tp__tilde__, P.tp, P.HL],
               color=['Identity(1,2)'],
               lorentz=[L.FFS3, L.FFS4],
               couplings={(0, 0): C.GC_149, (0, 1): C.GC_149})
...
V_175 = Vertex(name='V_175',
               particles=[P.W__minus__, P.W__minus__,
                          P.W__plus__, P.W__plus__],
               color=['1'],
               lorentz=[L.VVVV5],
...
V_178 = Vertex(name='V_178',
               particles=[P.tp__tilde__, P.b, P.G__plus__],
               color=['Identity(1,2)'],
               lorentz=[L.FFS4],
               couplings={(0, 0): C.GC_11})

V_179 = Vertex(name='V_179',
               particles=[P.tp__tilde__, P.b, P.H__plus__],
               color=['Identity(1,2)'],
               lorentz=[L.FFS4],
